%% Thresholding on gradient magnitudes after smoothing the image. %%
close all;
clear;

%% Smoothing the images before differentiation.

tools = godthem256; few = few256;

% Smoothing the images.
tools = discgaussfft(tools, 0.5); few = discgaussfft(few, 0.5);
